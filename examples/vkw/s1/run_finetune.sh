...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    for x in ${finetune_set} ${finetune2_set}; do
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    for ((i = 0; i < $num_gpus; ++i)); do
    {
        ...
        python3 wenet/bin/train.py --gpu $gpu_id \
            --config $train_config \
            --train_data $feat_dir/${finetune2_set}/format.data.char \
    ...
    #for sets in ${test_set}; do
        ...
        for y in "stv" "lgv" "liv"; do
            ...
            if [ $y == "lgv" ]; then
                ...
                ./data/vkw/scripts/bin/results_to_score.sh $new_dir/data/vkw/score/dev_${y}/ecf \
                ...
                ./data/vkw/scripts/bin/F1.sh $dir/dev_${y}/kws_outputs/f4de_scores_unnormalized/alignment.csv
            elif [ $y == "liv" ]; then
