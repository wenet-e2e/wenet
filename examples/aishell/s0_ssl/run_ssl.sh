#!/bin/bash
# Copyright 2022 Tencent Inc. (Author: Kai Tang).
# Apach 2.0
...
train_config=conf/train_base_conformer_100h.yaml
cmvn=true
dir=exp/conformer_w2vbase
checkpoint=
...
enc_init=$pretrain_dir/w2vc_base12_7wh.pt
#reinit last pretrained encoder layer : https://arxiv.org/pdf/2107.04734.pdf
enc_init_mods='encoder.global_cmvn,encoder.encoders.0.,encoder.encoders.1.,encoder.encoders.2.,encoder.encoders.3.,encoder.encoders.4.,encoder.encoders.5.,encoder.encoders.6.,encoder.encoders.7.,encoder.encoders.8.,encoder.encoders.9.,encoder.encoders.10.,encoder.embed'
