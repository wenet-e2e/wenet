...
train_set=train_l-aishell4  # manully merge data/train_l/data.list and ../../aishell4_train/data.list into data/train_l-aishell4/data.list
dev_set=dev
test_sets="test_net test_meeting aishell4_test"

train_config=conf/fintune_paraformer_dynamic.yaml
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
  ...
  if [ ${average_checkpoint} == true ]; then
    decode_checkpoint=$dir/avg${average_num}_mode${average_mode}.pt
  ...
  {
    pthon wenet/bin/recognize.py --gpu 0 \
      --modes $decode_modes \
