        ...
        {
            {
                ...
                python wenet/bin/recognize.py --gpu $gpu_id \
                    ...
                    --penalty 0.0 \
                    --dict $dict \
                    --result_file $test_dir/text_bpe_${ctc_weight}_${average_num} \
                    --ctc_weight $ctc_weight \
                    ${decoding_chunk_size:+--decoding_chunk_size $decoding_chunk_size}
                tools/spm_decode --model=${bpemodel}.model --input_format=piece < $test_dir/text_bpe_${ctc_weight}_${average_num} | sed -e "s/▁/ /g" > $test_dir/text_${ctc_weight}_${average_num}
                python tools/compute-wer.py --char=1 --v=1 \
                    $wave_data/gigaspeech_$test/text $test_dir/text_${ctc_weight}_${average_num} > $test_dir/wer_${ctc_weight}_${average_num}
            } &
