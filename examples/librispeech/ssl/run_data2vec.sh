...
datadir=/apdcephfs/share_1157259/train/asr/egs/english2/dump
# wav data dir
wave_data=data
# Optional train_config
# 1. conf/train_transformer_large.yaml: Standard transformer
pretrain_config=conf/pretrain/train_conformer_pretrain_data2vec.yaml
# finetune_config
finetune_config=conf/finetune/train_conformer_100h_data2vec.yaml
checkpoint=
cmvn=true
do_delta=false

pretrain_dir=exp/pretrain_d2v_960h
finetune_dir=exp/finetune_d2v_spec_aug_100h
...
#finetune 100h using data2vec model  
