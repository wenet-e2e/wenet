...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    tools/remove_longshortdata.py --maxframes 3000 --maxchars 400 data/${train_set}_org data/${train_set}
    tools/remove_longshortdata.py --maxframes 3000 --maxchars 400 data/${train_dev}_org data/${train_dev}
