...
class RelPositionalEncoding2(RelPositionalEncoding):
    def __init__(self, d_model: int, dropout_rate: float, max_len: int = 5000):
        super(RelPositionalEncoding2, self).__init__(d_model, dropout_rate, max_len)
...
#     print('pos_emb.pe.size()', pos_emb.pe.size())
#     x = torch.rand(2, 128, 256)
#     print(pos_emb.pe.size(1) // 2 - x.size(1) + 1, pos_emb.pe.size(1) // 2 + x.size(1))
#     pos = pos_emb(x)
#     print('pos', pos[1].size())