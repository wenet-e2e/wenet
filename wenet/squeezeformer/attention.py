...
if __name__ == '__main__':
    ...
    # rel_mha = RelPositionMultiHeadedAttention(4, 256, 0.1)
    # x = torch.rand(2, 128, 256)
    # pos = pos_emb(x, 0)
    # print('pos', pos[0].size())
    # print('pos', pos[1].size())
    # length = torch.tensor([128, 128])
    # mask = ~make_pad_mask(length).unsqueeze(1)
    # x = rel_mha(x, x, x, mask, pos[1])
    # print('x', x.size())
