...
from wenet.data2vec.data2vec_encoder import Data2vecConformerEncoder
...
class Data2vecModel(torch.nn.Module):
    ...
    def __init__(
        ...
        self.pretrain=data2vec_conf.get('pretrain',False)
        self.encoder_grad_mult=data2vec_conf.get('encoder_grad_mult',1.0)
        self.freeze_finetune_updates=data2vec_conf.get('freeze_finetune_updates',0)
        self.num_updates=0

        self.log_interval=data2vec_conf.get('log_interval',100)
        self.accum_grad=data2vec_conf.get('accum_grad',4)
...
def init_data2vec_model(configs):
    ...
    if encoder_type == 'conformer':
        encoder = Data2vecConformerEncoder(data2vec_conf,
                                   input_dim,
