...
if __name__ == '__main__':
    librispeech = compute_max_steps(
        max_epochs=120, accumulate_grad_batches=4, limit_train_batches=100000,
        num_workers=8, num_samples=281241, batch_size=12, drop_last=False)
    print('librispeech max step: {}'.format(librispeech))
