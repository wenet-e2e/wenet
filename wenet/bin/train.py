...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_list', required=True, help='train data files list')
    parser.add_argument('--cv_data_list', required=True, help='cv data files list')
    ...
    train_dataset = MxfeatsIterableDataset(client, train_data_lst, mean, var, feat_dim)
    ...
    cv_dataset = MxfeatsIterableDataset(client, cv_data_lst, mean, var, feat_dim)
