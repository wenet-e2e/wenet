...
def export_encoder(asr_model, args):
    ...
    ort_session = onnxruntime.InferenceSession(encoder_outpath, providers=['CoreMLExecutionProvider', 'CPUExecutionProvider'])
...
def export_ctc(asr_model, args):
    ...
    ort_session = onnxruntime.InferenceSession(ctc_outpath,providers=['CoreMLExecutionProvider', 'CPUExecutionProvider'])
...
def export_decoder(asr_model, args):
    ...
    ort_session = onnxruntime.InferenceSession(decoder_outpath, providers=['CoreMLExecutionProvider', 'CPUExecutionProvider'])
