...
#ifndef DECODER_TORCH_ASR_MODEL_EFFICIENT_H_
#define DECODER_TORCH_ASR_MODEL_EFFICIENT_H_
...
class TorchAsrModelEfficient : public AsrModel {
 public:
#ifndef IOS
 ...
 public:
  ...
  TorchAsrModelEfficient() = default;
  TorchAsrModelEfficient(const TorchAsrModelEfficient& other);
...
#endif  // DECODER_TORCH_ASR_MODEL_EFFICIENT_H_
