    ...
    elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
      if(CXX11_ABI)
        if(NOT GPU)
          ...
          set(LIBTORCH_URL "https://download.pytorch.org/libtorch/cu113/libtorch-cxx11-abi-shared-with-deps-${PYTORCH_VERSION}%2Bcu113.zip")
        ...
        if(NOT GPU)
          ...
          set(LIBTORCH_URL "https://download.pytorch.org/libtorch/cu113/libtorch-shared-with-deps-${PYTORCH_VERSION}%2Bcu113.zip")
